-- =====================================================
-- SAMIA TAROT - COMPLETE ADVANCED ADMIN FEATURES V2 (FIXED)
-- =====================================================
-- Fixed version that handles missing 'users' table and uses correct SAMIA TAROT schema

BEGIN;

DO $$
BEGIN
    RAISE NOTICE '🚀 Starting Complete Advanced Admin Setup V2 (FIXED)...';
    RAISE NOTICE 'This version handles missing tables gracefully';
END $$;
...
-- =====================================================
-- SAFELY ADD SOFT DELETE COLUMNS TO EXISTING TABLES
-- =====================================================
...
BEGIN
    ...
    -- Skip the non-existent 'users' table that was causing the error
    RAISE NOTICE '⚠️ Skipping users table (does not exist in SAMIA TAROT schema)';
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '🎉 COMPLETE ADVANCED ADMIN SETUP V2 (FIXED) FINISHED!';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '✅ Fixed: Handles missing users table gracefully';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'The "users table does not exist" error has been resolved!';
    RAISE NOTICE 'All features are compatible with SAMIA TAROT schema!';
    RAISE NOTICE '';
END $$; 
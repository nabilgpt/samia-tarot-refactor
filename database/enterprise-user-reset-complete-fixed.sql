-- ============================================================================
-- ENTERPRISE USER RESET - COMPLETE PROCESS (FIXED VERSION)
...
DECLARE
    ...
    -- Helper functions
    FUNCTION table_exists(p_table_name TEXT) RETURNS BOOLEAN AS $func$
    BEGIN
        RETURN EXISTS (
    ...
    FUNCTION column_exists(p_table_name TEXT, p_column_name TEXT) RETURNS BOOLEAN AS $func$
    BEGIN
        RETURN EXISTS (

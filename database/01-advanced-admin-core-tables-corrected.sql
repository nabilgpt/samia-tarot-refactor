-- =====================================================
-- SAMIA TAROT - ADVANCED ADMIN FEATURES - PART 1 (CORRECTED)
...
BEGIN
    ...
    RAISE NOTICE 'Starting advanced admin tables creation';
END $$;
...
CREATE TABLE IF NOT EXISTS admin_audit_logs (
    ...
    target_table VARCHAR(100) NOT NULL, -- Changed from table_name to target_table

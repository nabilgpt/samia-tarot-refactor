-- SAMIA TAROT: Step 3 - Insert Bilingual Notification Templates (COMPLETE)
-- This script populates notification_templates with comprehensive Arabic/English content
-- Includes ALL required columns based on actual table structure
-- Safe to run multiple times (uses ON CONFLICT DO UPDATE)

-- ============================================================================
-- STEP 3: INSERT BILINGUAL NOTIFICATION TEMPLATES (COMPLETE VERSION)
-- ============================================================================
...
BEGIN
    ...
    RAISE NOTICE 'Inserting comprehensive bilingual notification templates (COMPLETE VERSION)...';
    ...
    INSERT INTO notification_templates (
        ...
        title_template, body_template, message_template,
        title_en, message_en, 
        title_ar, message_ar
    ) VALUES (
        'approval_pending',
    ...
    RAISE NOTICE '========================================';
    RAISE NOTICE 'STEP 3 COMPLETED SUCCESSFULLY (COMPLETE)';
    RAISE NOTICE 'Inserted 15 comprehensive bilingual templates with ALL required columns:';
    RAISE NOTICE '- title_template, body_template, message_template (legacy compatibility)';

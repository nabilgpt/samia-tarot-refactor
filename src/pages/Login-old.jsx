...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black flex items-center justify-center relative overflow-hidden">
      ...
      >
        <div className="bg-gray-800/30 backdrop-blur-lg border border-purple-500/20 rounded-2xl p-8 shadow-2xl">
          {/* Header */}
          <motion.div
          ...
          >
            ...
            <motion.button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 disabled:hover:scale-100 shadow-lg hover:shadow-purple-500/25"
          ...
          >
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="inline-flex justify-center items-center px-4 py-3 border border-gray-600 rounded-xl bg-gray-700/30 text-gray-300 hover:bg-gray-700/50 transition-colors"
              >

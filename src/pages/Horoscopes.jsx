      ...
      >
        <div className="container mx-auto px-4">
              ...
              {zodiacSigns.map((sign) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`group bg-theme-card backdrop-blur-sm border rounded-xl p-6 transition-all duration-300 shadow-theme-card ${
                      horoscope
          ...
          {!loading && horoscopes.length === 0 && (
            <motion.div variants={itemVariants} className="text-center py-16 mt-12">
              <motion.div
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-sm mx-auto">
                <Link
                  to="/services"
                  className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 bg-cosmic-gradient hover:shadow-theme-cosmic text-theme-inverse font-semibold rounded-xl transition-all duration-300 transform hover:scale-105"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3 bg-transparent border border-theme-cosmic text-theme-primary hover:bg-theme-cosmic hover:text-theme-inverse rounded-xl transition-all duration-300"
                >
                  Refresh
                </button>
              </div>

// =================================================
// SAMIA TAROT BILINGUAL INPUT COMPONENT
// Single-language input that shows ONLY the current language
// =================================================
...
const BilingualInput = ({
  ...
  // Handle input change for current language only
  ...
  // Base input classes with cosmic theme and RTL support
  const inputClasses = `

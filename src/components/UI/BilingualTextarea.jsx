// =================================================
// SAMIA TAROT BILINGUAL TEXTAREA COMPONENT
// Single-language textarea that shows ONLY the current language
// =================================================
...
const BilingualTextarea = ({
  ...
  // Handle textarea change for current language only
  ...
  // Base textarea classes with cosmic theme and RTL support
  const textareaClasses = `
    ...
    resize-vertical min-h-[${rows * 1.5}rem]

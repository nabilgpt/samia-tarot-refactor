// Execute Enhanced Providers System migration step by step
...
async function executeMigration() {
    ...
    try {
        ...
        const { error: modelsError } = await supabase.rpc('exec_sql', {
            sql: `
        ...
        const { error: secretsError } = await supabase.rpc('exec_sql', {
            sql: `
        ...
        // Insert providers
        const { error: providersInsertError } = await supabase
            .from('providers')
            .upsert([

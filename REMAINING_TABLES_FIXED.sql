-- 🚀 SAMIA TAROT - REMAINING TABLES (FIXED RAISE SYNTAX)
...
-- ==============================================================================
-- SUCCESS MESSAGE (FIXED RAISE SYNTAX)
-- ==============================================================================

DO $$
DECLARE
    total_tables INTEGER := 0;
    table_count_text TEXT;
BEGIN
    ...
    -- Create count text for display
    table_count_text := total_tables::TEXT || ' / 13';
    
    RAISE NOTICE '';
    RAISE NOTICE '🎉 REMAINING TABLES SETUP COMPLETE!';
    RAISE NOTICE '';
    RAISE NOTICE '📊 Total Critical Tables: %', table_count_text;
    RAISE NOTICE '';

...
create or replace view tarot.deck_uploads as select * from public.deck_uploads;
...
create or replace view calls.consent_logs as select * from public.call_consent_logs;
...
create or replace view ops.reader_emergency_optin as select * from public.reader_emergency_requests;
create or replace view ops.reader_availability_overrides as select * from public.reader_availability_overrides;

create or replace view payments.transactions as select * from public.payment_transactions;
